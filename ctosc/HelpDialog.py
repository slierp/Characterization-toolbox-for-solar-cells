...
<p><h2><a name="pl">QSSPC lifetime data</a></h2></p>
The program currently support output files from the Sinton WCT-120 program (.txt files).
After loading the data files the lifetime data plots can be generated by selecting or double-clicking on any of the loaded items.
It is possible to select multiple data sets in order to combine them in the same plot image.
</p>
